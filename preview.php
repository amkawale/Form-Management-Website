...
<body class="sb-nav-fixed">
    ...
    <script>
        ...
        function loadProject() {
            ...
            console.log(mydata);
            var json_input = (mydata);
            var script = "preview_fm_form_ajax.php";
            $.post(script, {
                json_param: json_input
            },
                function (result, status) {
    ...
    <script>
        ...
        function loadTab(oid) {
            ...
            console.log(mydata);
            var json_input = (mydata);
            var script = "preview_fm_tab_ajax.php";
            $.post(script, {
                json_param: json_input
            },
                function (result, status) {
        ...
        function loadPanel(oid) {
            ...
            var json_input = mydata;
            var script = "preview_form_panel_ajax.php";
        ...
        function loadSection(panel_oid, section_oid_list) {
            ...
            var script = "preview_form_section_ajax.php";
        ...
        function saveobjectmappingData() {
            ...
            // return;
            var json_input = (mydata);
            var script = "preview_objectmapping_save.php";
            // $('#div_loading').fadeIn();
            $.post(script, {
                json_param: json_input
            },
        ...
        function getObject() {
            ...
            // return;
            var json_input = (mydata);
            var script = "preview_get_objectmapping.php";
            // $('#div_loading').fadeIn();
            $.post(script, {
                json_param: json_input
            },

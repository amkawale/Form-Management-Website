...
function renderTab($tab_oid, $form_id, $form_mode)
{
    ...
    $tab_body_start .= "<div class='container-fluid configure-panel' style=''>
        <button class='btn btn-primary btn-sm' title='Add Panel' onclick='loadCreatePanelModal(\"$tab_oid\")'> 
            <i class='fa fa-plus' aria-hidden='true'></i> 
        </button>
        <button class='btn btn-warning btn-sm' title='Configure Tab' onclick='loadConfigureTabModal(\"$tab_oid\")'> 
            <i class='fa fa-wrench' aria-hidden='true'></i> 
        </button>
        <button class='btn btn-danger btn-sm' title='Delete Tab' onclick='deleteTab(\"$tab_oid\")'> 
